...
def main(_):
  ...
  for year in years:
    ...
    annotations_dir = "../../drive/Shareddrives/Dataset UAV/Iga/Tensorflow/VisDrone2019-DET-train/annotations_xml"
    ...
    # for idx, example in enumerate(examples_list):
      ...
      # direc_new = "/media/inn/Files/automl/efficientdet/VOCdevkit/"
